  ...
  var game = {
    ...
    loop: function () {
      ...
      function HitWall() {
        ...
        if ((player.x >= 4 && player.x <= 6) && (player.y >= 4 && player.y <= 6)) 
          {game.reset();}
      ...
      if (player.x == fruit.x && player.y == fruit.y) {
        ...
        // ?faire de tel sorte que un fruit n'apparaisse pas dans la queu
      ...
      if(stopped) {
        ...
        ctx.fillText("press any touch", 24, 374);
      }
      ...
      ctx.fillText("MAX: " + pointsMax, 292, 60);
